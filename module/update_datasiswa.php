    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if (isset($check_ifexist)) {
            ...
            if (mysqli_query($_AUTH, $query_update_datasiswa)){
                $query_update_siswa = "UPDATE `tbl_siswa` SET `nama_siswa` = '$nama_siswa', `jenis_kelamin` = '$jenis_kelamin', `alamat` = '$alamat', `no_telp` = '$no_telp', `email` = '$email' WHERE `tbl_siswa`.`nis` = '$nis'";
